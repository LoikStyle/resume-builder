...
export default function SubscenarioPicker({ category, selected, onToggle }: Props) {
  ...
  return (
    <div className="space-y-2">
      <p className="text-xs text-slate-500">
        AI 列出 {items.length} 个细分方向，勾选 1-3 个最贴近你的（已选 {selected.length}/3）
      </p>
